...
import { ProfileClient } from "src/clients/bazar";
import { INftSaleClient, NftSaleClientConfig } from "src/clients/miscellaneous/nft-sale/abstract";
 ...
 * @deprecated
 */
export class NftSaleClient extends AsyncAutoConfigBaseClient implements INftSaleClient {
    /* Fields */
