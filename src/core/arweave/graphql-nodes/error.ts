...
import { IArweaveNodeClient } from "./abstract";

export class ArweaveNodeClientError<T extends IArweaveNodeClient, P = any> extends ClientError<T, P> {
	constructor(
...
export class MalformedArweaveNodeResponseError<T extends IArweaveNodeClient, P = any> extends ClientError<T, P> {
	constructor(
		public readonly client: T,
		public readonly func: Function,
		public readonly clientFunctionParams: P,
