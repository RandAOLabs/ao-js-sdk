import { PIOracleClient, PIDelegateClient, DelegationHistorianClient, PITokenClient, TokenClient, DelegationInfo, DelegationRecord, ProjectDelegationTotal, PIToken } from "../../../clients";
import { AO_CONFIGURATIONS } from "../../../core/ao/ao-client/configurations";
import { staticImplements, IAutoconfiguration } from "../../../utils";
import { DelegationPreference } from "../pi-data-service/abstract/responses";
import { IPIService, PITokenExtended } from "./abstract/IPIService";
