...
export interface IRandAOService {
	...
	/**
	 * Gets the most recent entropy from the most recent transaction
	 * @returns Promise of the entropy string from the most recent transaction.
	 */
	getMostRecentEntropy(): Promise<string>;
}
