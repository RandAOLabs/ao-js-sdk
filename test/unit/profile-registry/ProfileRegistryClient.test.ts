import { ProfileRegistryClient } from "../../../src/clients/process/profile-registry";
...
jest.mock("../../../src/clients/process/profile-registry/ProfileRegistryClientAutoConfiguration", () => ({
